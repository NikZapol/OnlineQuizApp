...
import com.example.onlinequizapp.MyAdapterArchive;
...
public class RecordsFragmentInstructor extends Fragment {

    FirebaseUser user;
    DatabaseReference referenceUsers, referenceLessons, referenceLessonsArchive;
    String userID;
    ...
    MyAdapterArchive myAdapterArchive;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        referenceLessonsArchive = FirebaseDatabase.getInstance().getReference("Lessons_archive");
        userID = user.getUid();
        ...
        list = new ArrayList<>();
        myAdapterArchive = new MyAdapterArchive(getContext(), list);
        recyclerView.setAdapter(myAdapterArchive);
    ...
    private void getLessonsData() {
        Query query = referenceLessonsArchive.orderByChild("instructor").equalTo(fullnameTV.getText().toString());
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    lessonid = referenceLessonsArchive.push().getKey();
                    useridTV.setText(userId);
                    lessonidTV.setText(lessonid);
                }
                myAdapterArchive.notifyDataSetChanged();
            }
